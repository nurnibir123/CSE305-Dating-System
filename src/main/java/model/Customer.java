...
public class Customer {
	...
	/*
	 * This class is a representation of the customer table in the database Each
	...
	public String toString() {
		return "The Customer Details are: <br/>Customer ID=" + userID + "<br/>First Name=" + firstName
				+ "<br/>Last Name=" + lastName + "<br/>Address=" + Address + "<br/>City=" + City + "<br/>State=" + State
				+ "<br/>Zip Code=" + zipCode + "<br/>Telephone=" + telephone + "<br/>Email=" + email
				+ "<br/>Credit Card=" + creditCard + "<br/>Rating=" + rating;
	}
